...
# --- LLM: DeepSeek (único provider) ------------------------------------------
# API OpenAI-compatible. Slug explícito — os aliases legados
...
deepseek_client = OpenAI(base_url="https://api.deepseek.com", api_key=DEEPSEEK_API_KEY, max_retries=4)
